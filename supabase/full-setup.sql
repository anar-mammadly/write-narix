...
-- ---------- supabase/migrations/20260101000018_promo_code_approval.sql ----------
...
-- ---------------------------------------------------------------------------
-- hotfix-021: admin-entered "post-review final price" (reviewed_price)
-- that supersedes the calculator-derived total once set — referral/promo
-- approval percentages then apply directly to it. Also: admin-only
-- customer contact lookup, and closing an email-harvesting hole on
-- profile_email() (never revoked from anon/authenticated).
-- ---------------------------------------------------------------------------
