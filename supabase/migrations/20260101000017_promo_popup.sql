...
insert into site_settings (key, value) values
  ('promo_popup', jsonb_build_object(
    ...
    'description', 'Bu ay buraxılış və dissertasiya sifarişlərinizə 15% endirim əldə edin — üstəlik 5 əlavə xidməti PULSUZ əldə edin.',
    'description_en', 'Get 15% off your graduation and dissertation orders this month — plus receive 5 additional services FREE.',
